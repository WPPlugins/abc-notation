...
function abcjs_loader() {
	...
	wp_enqueue_script( 'abcjs-plugin', plugins_url( '/abcjs_basic_midi_3.0.1-min.js', __FILE__ ));
}

//-- Add the CSS for the MIDI controls
function load_midi_css() {
    $plugin_url = plugin_dir_url( __FILE__ );

    wp_enqueue_style( 'style1', $plugin_url . 'abcjs-midi.css' );
}

add_action( 'wp_enqueue_scripts', 'load_midi_css' );
...
function create_midi( $atts, $content ) {
	$a = shortcode_atts( array(
		'class' => 'abc-midi',
		'parser' => '{}',
		'midi' => '{}'
...
add_shortcode( 'abcjs-midi', 'create_midi' );
